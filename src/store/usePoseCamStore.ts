...
export const usePoseCamStore = create<PoseCamState>((set, get) => ({
  ...
  setOverlayImage: (image) =>
    set((s) => ({ overlay: { ...s.overlay, image, x: 0, y: 0, scale: 1, rotation: 0 }, activeTemplateId: null })),
  ...
  deleteTemplate: (id) => {
    ...
    persistTemplates(templates)
    set({ templates, activeTemplateId: s.activeTemplateId === id ? null : s.activeTemplateId })
  },
}))
