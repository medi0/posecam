      ...
      <div className="p-4 space-y-4">
        {activeTab === "overlay" && (
          <>
            ...
            <Slider
              ...
              min={30}
              max={250}
              onChange={(v) => setOverlayScale(v / 100)}
              format={(v) => `${v}%`}
            />
            <Slider
              label="Rotate"
        ...
        {activeTab === "capture" && (
          <>
            ...
            <div>
              <p className="flex items-center gap-1.5 text-[10px] text-white/50 font-medium tracking-widest uppercase mb-2">
                <Layers3 size={11} /> Burst —{" "}
                {burstCount === 1 ? "off" : `${burstCount} shots`}
              </p>
            ...
            <div>
              ...
              <p className="text-[10px] text-white/35 mt-1.5 leading-relaxed">
                Preview mirroring flips your live view like an Android selfie
                camera. Turn on "Mirror saved photo" too if you want the
                captured shot to match what you saw, rather than the true
                unflipped camera frame.
              </p>
            </div>
          </>
        )}
